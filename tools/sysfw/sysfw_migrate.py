...
SYSFW_INNER_CERT_NAME = f"ti-sci-firmware-{SOC}-hs-cert.bin"
...
get_git_file(SYSFW_REL_GIT_URL, release_tag, f"binaries/{SYSFW_INNER_CERT_NAME}", 1)
copyfile(SYSFW_INNER_CERT_NAME, sciclient_path+f"/soc/{SOC_FOLDER}/sysfw-hs-enc-cert.bin")
