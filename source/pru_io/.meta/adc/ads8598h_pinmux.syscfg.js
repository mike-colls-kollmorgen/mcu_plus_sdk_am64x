...
function getPeripheralRequirements(inst, peripheralName)
{
    ...
    if (peripheralName=="IEP")
    {
        if (inst.combinedConvst) {
            ...
            // CONVST signals: PRU0_GPO19, PRU0_GPO20 (IEP0_SYNC_OUT0, IEP0_SYNC_OUT1)
...
function moduleInstances(instance) {
    ...
    return [{
            name: "power1",
            displayName: "Adaptor Power Enable Pin 1",
        ...
        {
            name: "power2",
            displayName: "Adaptor Power Enable Pin 2",
            moduleName: "/drivers/gpio/gpio",
        ...
        {
            name: "power3",
            displayName: "Adaptor Power Enable Pin 3",
            moduleName: "/drivers/gpio/gpio",
        ...
        {
            // jumper J9 on adaptor board: was meant for switching between serial and eSPI on 9224 adc
...
let ads8598h_pinmux_top_module_name = "/pru_io/adc/ads8598h_pinmux";

let ads8598h_pinmux_top_module = {
    displayName: "ADC Configuration",

    templates: {
        "/drivers/pinmux/pinmux_config.c.xdt": {
            moduleName: ads8598h_pinmux_top_module_name,
        },
    },
    ...
    config: [
        ...
        },
        {
            ...
            description: "Keep the jumper J9 on Adaptor Board in parallel mode for all cases",
            options: [{
                name: "parallel",
        ...
        },
        {
            ...
            description: "Adjust the jumper J7 on Adaptor Board for this setting to work",
            default: true,
        },
    ],
    pinmuxRequirements,
...
exports = ads8598h_pinmux_top_module;
