...
function getPeripheralRequirements(inst, peripheralName)
{
    ...
    if (peripheralName=="IEP")
    {
        if (inst.combinedConvst) {
            ...
            resources.push(pinmux.getPinRequirements(interfaceName, "EDC_SYNC_OUT1", "CONVST (A&B) "));
        } else {
    ...
    else if (peripheralName=="PRU")
    {
        ...
        // CS
        resources.push(pinmux.getPinRequirements(interfaceName, "GPO17", "C̅S̅ "));
        // FIRST
        resources.push(pinmux.getPinRequirements(interfaceName, "GPI18", "FRSTDATA "));
        // READ
...
function pinmuxRequirements(inst) {
    ...
    pinmux.setPeripheralPinConfigurableDefault(pru, "GPO17", "pu_pd", "nopull");
...
let am64x_adapter_top_module_name = "/pru_io/adc/ads85x8/am64x_adapter";

let am64x_adapter_top_module = {
    displayName: "ADC Configuration",

    templates: {
        "/drivers/pinmux/pinmux_config.c.xdt": {
            moduleName: am64x_adapter_top_module_name,
        },
    },
...
exports = am64x_adapter_top_module;
